<script>
   ...
   /** 
    * @import { TJSProseMirrorOptions }   from '#standard/component/fvtt/editor';
    */
   ...
   const options = {
      ...
      // menuCompact: false,  // Initialize the ProseMirror editor w/ a compact menu (sans font selection).
   ...
   /**
    * Bound variable to `enrichedContent` prop of TJSContentEdit.
    * 
